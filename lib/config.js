...
const config = convict({
  email: {
    host: {
      'default': 'restmail.net.ymonitor.nl',
  ...
  // than this limit, an error will be returned and the connection will be terminated.
  ...
  redis: {
    host: {
      'default': 'test-restmail.7dm0yp.0001.euw1.cache.amazonaws.com',
      doc: 'Redis host.',
      env: 'REDIS_HOST',
      format: String
    },
